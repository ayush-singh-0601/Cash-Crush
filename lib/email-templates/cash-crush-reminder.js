    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          ${getMessageContent(reminderType, senderName, isGroup, groupName, customMessage)}
          ...
          <div class="description">
            <div class="description-label">Personal Message</div>
            <p class="description-text">${customMessage}</p>
          </div>
          ` : ''}
...
function getMessageContent(reminderType, senderName, isGroup, groupName, customMessage) {
  // If there's a custom message, use it as the main content
  ...
  // Otherwise use the predefined templates
  switch (reminderType) {
    case 'urgent':
      return `
        <div class="message">
    ...
    case 'funny':
      return `
        <div class="message">
          ...
          We may never know, but we do know it needs to come back home${isGroup ? ` to settle the ${groupName} group balance` : ''}! 😄<br><br>
          Just kidding! But seriously, a friendly reminder that you have an outstanding balance. No pressure though! 😊
        </div>
      `;
    ...
    case 'polite':
      return `
        <div class="message">
          ...
          Settle up whenever it's convenient for you. Thank you for being so understanding! 🙏
        </div>
      `;
